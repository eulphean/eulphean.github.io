...
import pdf from './3d-one-2023.pdf' // A general portfolio (without Creative Technologist branding)
...
class Threedone extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
    };
...
export default Radium(Threedone);