...
const body=<span><CustomLink to='https://momimsafe.live' inline={true}>momimsafe.live</CustomLink> is an interactive website that ran as an active live-stream of my home studio space in Chicago from April - August, 2020, where I spent the majority of my time during the Coronavirus pandemic. It was intially developed in response to the COVID-19 lockdown, with an urgent need in mind; to be visually and physically accessible to all my global friends and family. An alternate mode of intimacy allowed one to also send a message from the website, which got printed in real-time in my space with a thermal printer. The work is now in an archived state, where a single video is playing on loop.</span>
const bodyB=<span><CustomLink to="https://momimsafe.live/#/printer" inline={true}>Virtual Printer</CustomLink> is an interactive simulation of the thermal printer placed in my home studio. This simulacra allows participants to explore the entire database of messages received during this work.</span>
const bodyC=<span><span style={cvStyles.title}>Labour of Love</span> (top) is an on-going series that pins these messages as a reminder of empathy, resilience, and strength in a time of uncertainty and isolation.<span style={cvStyles.title}>(covid-19) Antidote</span> (bottom) is a limited edition artist book that reinterprets these messages with medicinal values.</span>
