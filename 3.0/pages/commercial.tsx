  ...
  return (
    <div className="overflow-x-hidden">
      ...
      <main className="w-[100dvw] h-[100dvh] overflow-x-hidden overflow-y-scroll select-none overscroll-none bg-black">
        ...
        <section
          ref={section1Ref}
          className="h-screen flex items-center justify-center border-b border-gray-800 relative overflow-hidden"
        >
        ...
        <section
          ref={section2Ref}
          className="h-screen relative flex items-center justify-center border-b border-gray-800"
        >
          <VideoPlayer
        ...
        <section
          id="how-can-i-help"
          className="min-h-screen flex items-center justify-center py-8 sm:py-16 px-4 bg-black"
        >
          <ContactForm />
        </section>
