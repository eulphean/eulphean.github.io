...
export default function VideoPlayer (props: PopupProps) {
    ...
    return (
        <div className="overflow-hidden fixed inset-0 z-50 flex flex-col items-center justify-center">
          ...
          {/* Popup Content */}
          <div className="relative flex flex-col items-center h-auto bg-gray-900 bg-opacity-95 rounded-lg shadow-xl max-w-4xl w-full mx-4 z-50 max-h-[90vh] overflow-y-auto my-4">
            {/* Header */}
